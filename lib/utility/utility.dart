...
Future<void> saveUserData(Map<String, dynamic> responseBody) async {
  ...
  await prefs.setString('password', userData['password']); // Storing password in SharedPreferences is not recommended
  await prefs.setString('createdDate', userData['createdDate']);
